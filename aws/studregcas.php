  ...
  <div style="text-align:center">
    ...
    <div class="column">
      <form action="" method="post">
        ...
        <input type="text" name = "venue" value="venue" placeholder="">
...
$s_date= $_POST['s_date'];
$e_date= $_POST['e_date'];
$sql = "INSERT INTO regicas (pname,ename,etype,venue,reg_date,s_date,e_date) VALUES ('$pname','$ename','$etype','$venue','$reg_date','$s_date','$e_date')";
//print_r($sql);exit;
