...
<body>
    <div class="container">
        <form id="report" action="cas-publish.html">
            <label for="class">Class</label>
            <select id="class" name="class">
                <option value="bas">Bachelor in Allied Science</option>
                <option value="bpt">BPT</option>
                <option value="mpt">MPT</option>
                <option value="bscNursing">B.Sc Nursing(for Females)</option>
                <option value="bsc">B.Sc Nursing(for Trained nurses</option>
            ...
            <select id="Event_type" name="etype">
                <option value="Workshop">National League</option>
            ...
            <button type="button" onclick="generatexcel()">generate</button>
        </form>
    </div>
    <style>
        .container {
...
$sql = "INSERT INTO chsreport (class,ename,etype,from,to) VALUES ('$class','$ename','$etype','$from','$to')";
//print_r($sql);exit;
