    ...
    <div class="column">
      <form action="" method="post">
        ...
        <select id="Event_type" name="etype">
          <option value="Workshop">Regional and National Visitations</option>
          <option value="Symposium">Campus Events</option>
          <option value="Conferences">Conferences</option>
          <option value="Paper Presentations">Workshop</option>
          <option value="literary">Literary</option>
          <option value="Seminars">Seminars</option>
          <option value="Placement">Placements</option>
          <option value="Cokmpetitions">Competitions</option>
...
<input type='button'value='Get Student Details' class="btn" onclick="document.location.href='casreport.php';"/>
...
$s_date= $_POST['s_date'];
$e_date= $_POST['e_date'];
$sql = "INSERT INTO casfacpub (pname,ename,etype,description,reg_date,s_date,e_date) VALUES ('$pname','$ename','$etype','$description','$reg_date','$s_date','$e_date')";
//print_r($sql);exit;
            if (mysqli_query($conn, $sql)) {
               echo "New record created successfully";
			   header("location:favresponsivecas.php");
         } else {
