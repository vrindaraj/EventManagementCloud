...
<input type='button'value='Get Student Details' class="btn" onclick="document.location.href='iimreport.php';"/>
...
$s_date= $_POST['s_date'];
$e_date= $_POST['e_date'];
$sql = "INSERT facpubiim_new (pname,ename,etype,description,reg_date,s_date,e_date) VALUES ('$pname','$ename','$etype','$description','$reg_date','$s_date','$e_date')";
//print_r($sql);exit;
            if (mysqli_query($conn, $sql)) {
               echo "New record created successfully";
			   header("location:facresponsiveiim.php");
         } else {
