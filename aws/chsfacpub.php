    ...
    <div class="column">
      <form action="" method="post">
        ...
        <select id="Event_type" name="etype">
         <option value="Workshop">Conferences</option>
          <option value="Symposium">National league</option>
          <option value="Conferences">Expo</option>
          <option value="Paper Presentations">Paper presentation</option>
          <option value="Hackathon">placements</option>
          <option value="Hackathon">Exhibition</option>
          <option value="Hackathon">Placements</option>
          <option value="Hackathon">Cultural events</option>
        </select>
...
<input type='button'value='Get Student Details' class="btn" onclick="document.location.href='chsreport.php';"/>
...
$s_date= $_POST['s_date'];
$e_date= $_POST['e_date'];
$sql = "INSERT INTO chsfacpub (pname,ename,etype,description,reg_date,s_date,e_date) VALUES ('$pname','$ename','$etype','$description','$reg_date','$s_date','$e_date')";
//print_r($sql);exit;
            if (mysqli_query($conn, $sql)) {
               echo "New record created successfully";
			   header("location:facresponsivechs.php");
         } else {
