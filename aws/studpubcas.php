...
$s_date= $_POST['s_date'];
$e_date= $_POST['e_date'];
$sql = "INSERT INTO pubcas (pname,ename,etype,description,reg_date,s_date,e_date) VALUES ('$pname','$ename','$etype','$description','$reg_date','$s_date','$e_date')";
//print_r($sql);exit;
            if (mysqli_query($conn, $sql)) {
               echo "New record created successfully";
			  header("location:responsivecas.php");
         } else {
